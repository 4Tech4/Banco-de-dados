                ...
                <View>
                    ...
                    >                   
                        ...
                        >     
                            ...
                            <Text style={{ color: '#fff', fontSize:18 }}> Água: {data.agua}</Text>
                            <Text style={{ color: '#fff', fontSize:18 }}> Solo: {data.solo}</Text>
                            <Text style={{ color: '#fff', fontSize:18 }}> Bateria: {data.bateria}</Text>
                            <Text style={{ color: '#fff', fontSize:18 }}> Rega automática: {data.rega}</Text>
                                </View>
                            </View>
...
<Modal 
      ...
      >
         ...
         <TouchableOpacity
            ...
            >
              <EvilIcons name="close" size={15} color="black" />
            </TouchableOpacity>
